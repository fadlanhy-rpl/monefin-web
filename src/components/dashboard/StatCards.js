          ...
          <div className="flex justify-between items-start relative z-10">
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <p className="text-3xl font-extrabold tracking-tight tabular-nums min-h-[40px] flex items-center font-mono sm:font-sans">
                ...
                <button 
                  ...
                  className="p-1.5 hover:bg-white/10 rounded-lg transition-colors ml-1 cursor-pointer"
