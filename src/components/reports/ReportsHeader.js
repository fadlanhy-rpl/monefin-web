...
export default function ReportsHeader({
  ...
  return (
    <div className={`transition-all duration-700 ease-out transform ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"} flex flex-col gap-5`}>
      ...
      <div className="flex flex-wrap items-center gap-2.5 bg-white p-3.5 rounded-2xl border border-slate-100 shadow-sm">
        ...
        <div className="relative" ref={pickerRef}>
          ...
          {showCustomPicker && (
            <div className="absolute top-full left-0 mt-2 bg-white rounded-2xl shadow-2xl border border-slate-100 p-5 z-50 w-72 space-y-4 animate-in fade-in zoom-in-95 duration-150">
