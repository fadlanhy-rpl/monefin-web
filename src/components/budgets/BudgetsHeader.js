...
export default function BudgetsHeader({
  ...
  return (
    <div className={`transition-all duration-700 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'} flex flex-col md:flex-row md:items-center justify-between gap-4 overflow-hidden`}>
      ...
      <div className="flex flex-row items-center gap-3 overflow-x-auto no-scrollbar pb-2 pt-1 w-full md:w-auto select-none">
        ...
        <button 
          ...
          className="press-scale flex items-center gap-2 bg-[#00685F] text-white px-5 py-2.5 rounded-xl font-bold hover:bg-[#004D46] hover:shadow-lg transition-all hover:scale-[1.02] active:scale-95 shadow-md shadow-[#00685F]/20 cursor-pointer shrink-0"
        >
