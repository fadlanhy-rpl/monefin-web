...
import AchievedGoalsModal from "./AchievedGoalsModal";
    ...
    <div className="space-y-6 pt-4">
      <div className="flex justify-between items-center select-none">
        ...
        <button 
          ...
          className="text-sm font-black text-[#00685F] hover:underline flex items-center gap-1 cursor-pointer"
        >
      ...
      {achievedGoals.length === 0 ? (
        <div className="bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-8 text-center text-slate-400 text-xs sm:text-sm font-bold select-none">
          Belum ada target tabungan yang selesai. Tetap berjuang menabung! 💪
        </div>
      ) : (
