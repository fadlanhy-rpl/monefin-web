      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 text-center">
          <div className="space-y-1 p-2">
            ...
            <p className="text-[11px] sm:text-sm font-semibold text-slate-600">Efisiensi Pencatatan</p>
          </div>
          <div className="space-y-1 p-2">
            <p className="text-2xl sm:text-4xl font-black text-brand-600 tracking-tight">Rp 120M+</p>
            <p className="text-[11px] sm:text-sm font-semibold text-slate-600">Dana Terkelola</p>
          </div>
          <div className="space-y-1 p-2">
            <p className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tight">99.8%</p>
            <p className="text-[11px] sm:text-sm font-semibold text-slate-600">Akurasi Real-time</p>
          </div>
          <div className="space-y-1 p-2">
            <p className="text-2xl sm:text-4xl font-black text-emerald-600 tracking-tight">100%</p>
            <p className="text-[11px] sm:text-sm font-semibold text-slate-600">Gratis Selamanya</p>
          </div>
        </div>
      </div>
    </section>
