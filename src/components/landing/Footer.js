  ...
  return (
    <footer className="relative z-10 bg-[#eaf4f2] text-slate-600 py-8 sm:py-10 border-t border-slate-200/80 text-[11px] sm:text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        ...
        <p className="text-[11px] text-slate-500 text-center md:text-left leading-relaxed border-t border-slate-200/60 pt-3">
          MoneFin adalah <strong>platform manajemen keuangan pribadi gratis</strong> di Indonesia untuk mencatat pemasukan &amp; pengeluaran harian, otomatisasi anggaran 50/30/20, konversi kurs 4 mata uang (IDR, USD, EUR, SGD), pindai struk belanja panjang dengan AI Vision, dan kalkulator Split Bill.
        </p>
      </div>
    </footer>
  );
