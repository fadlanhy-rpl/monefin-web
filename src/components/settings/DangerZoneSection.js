  ...
  return (
    <div className="bg-red-50/60 p-5 sm:p-8 rounded-[2rem] sm:rounded-[2.5rem] border border-red-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 sm:gap-6 hover:shadow-md transition-all duration-300">
      <div className="flex items-start sm:items-center gap-3 sm:gap-4">
        ...
        <div>
          <h2 className="text-base sm:text-lg font-black text-red-600 leading-tight">Hapus Akun Permanen</h2>
          <p className="text-xs text-red-500/90 font-medium mt-1">Tindakan ini tidak dapat dibatalkan. Seluruh transaksi, anggaran, dan data finansial Anda akan dihapus selamanya.</p>
        </div>
      </div>
